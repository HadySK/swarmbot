...
def callbackrob1g(msg):
    ...
    goal_rob2.pose.position.x = position_.pose.position.x + shape_dist
    goal_rob2.pose.position.y = position_.pose.position.y - shape_dist
    goal_rob2.pose.orientation.z = position_.pose.orientation.z
    goal_rob2.pose.orientation.w = position_.pose.orientation.w

    goal_rob3.pose.position.x = position_.pose.position.x + shape_dist
    goal_rob3.pose.position.y = position_.pose.position.y + shape_dist
    goal_rob3.pose.orientation.z = position_.pose.orientation.z
    goal_rob3.pose.orientation.w = position_.pose.orientation.w  
...
def main():
    ...
    sub_rob1g = rospy.Subscriber('/rob1/move_base_simple/goal',PoseStamped,callbackrob1g)
